...
public class MatrixProcessing {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("\n1. (Додати матрицю)");
            System.out.println("2.  (Помножити матрицю на константу)");
            System.out.println("3.  (Множення матриць)");
            System.out.println("4.(Транспонувати матрицю)");
            System.out.println("5.  (Обчисліть визначник)");
            System.out.println("6. (Обернена матриця)");
            System.out.println("0. Exit");
            System.out.print("\nEnter your choice: 1, 2, 3, 4, 5, 6 or 0: ");
            String choice = scanner.nextLine();

            if (choice.equals("1")) {
                System.out.println("ATTENTION! (Розмір двох матриць повинен бути однаковим!)");
                addMatrices();
                ...
                System.out.println(" (Невірно введено, повторіть спробу.)");
            }
        }
    }
    ...
    public static void addMatrices() {
        ...
        if (matrixA.length != matrixB.length || matrixA[0].length != matrixB[0].length) {
            System.out.println("(Операція не може бути виконана.)");
            System.out.println(" (Розмір другої матриці повинен бути таким самим, як розмір першої матриці!)");
        } else {
    ...
    public static void multiplyByConstant() {
        ...
        while (true) {
            try {
                ...
                System.out.println("Incorrect input!  (Невірне введення! Ви повинні ввести число і тільки одне.)");
            }
        }
    ...
    public static void multiplyMatrices() {
        ...
        if (matrixA[0].length != matrixB.length) {
            System.out.println("(Операція не може бути виконана.)");
            System.out.println(" (Кількість стовпців у першій матриці повинна бути рівною кількості рядків у другій матриці.)");
        } else {
            System.out.println(" (Резульат):");
    ...
    public static void inverseMatrix() {
        ...
        int det = determinant(matrix);
        if (det == 0) {
            System.out.println(" (Ця матриця не має оберненої матриці)");
        } else {
            System.out.println("The result is (Результат):");
